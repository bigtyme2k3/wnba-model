...
(function(){{
 ...
 function renderResults(){{
   ...
   r.innerHTML=`<div class="section"><div class="resHero"><div><div class="s19badge">RESULTS · ${{esc(D.target_date)}}</div><h2 class="mono">Current Model Results</h2><div class="s19muted mono">Only eligible OVER/UNDER recommendations from ${{esc(D.current_model_version)}}. Research candidates and legacy models are excluded.</div></div><div class="resState mono">${{esc(status)}}</div></div>
