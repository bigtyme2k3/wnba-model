...
(function(){{
 ...
 function renderResults(){{
   const s=D.summary||{{}},c=D.current_model||{{}},p=c.performance||{{}},t=c.target?.recommended||{{}},legacy=D.legacy_reference?.performance||{{}},research=D.research_archive||{{}},cal=D.calibration_training_set||{{}},q=D.quarantine||{{}},quality=c.data_quality||{{}},recent=Array.isArray(c.recent_results)?c.recent_results:[];
   ...
   <div class="resPanel"><h3 class="mono">Latest graded BET recommendations</h3><div class="resTableWrap"><table class="resTable"><thead><tr><th>Date</th><th>Player / game</th><th>Pick</th><th>Model</th><th>Actual</th><th>Result</th><th>Book</th></tr></thead><tbody>${{rows||'<tr><td colspan="7">No verified explicit BET results yet.</td></tr>'}}</tbody></table></div></div>
