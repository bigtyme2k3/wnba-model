...
(function(){{
 ...
 function renderResults(){{
   const s=D.summary||{{}},c=D.current_model||{{}},p=c.performance||{{}},t=c.target?.recommended||{{}},y=c.yesterday||{{}},yd=y.all_directional||{{}},yb=y.bet||{{}},yr=y.research||{{}},legacy=D.legacy_reference?.performance||{{}},research=D.research_archive||{{}},cal=D.calibration_training_set||{{}},q=D.quarantine||{{}},quality=c.data_quality||{{}},recent=Array.isArray(c.recent_results)?c.recent_results:[];
