...
def main():
    ...
    data_payload={'alt_market_warehouse':payload,'active_alt_games':games,'active_alt_target_date':target}
    ...
    print({'alt_ladders':'filtered','target_date':target,'active_games':games})
