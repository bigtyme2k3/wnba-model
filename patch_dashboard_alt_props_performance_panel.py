...
.altPerfDaily{margin-top:12px}.altPerfDailyTable{width:100%;border-collapse:collapse;min-width:820px}.altPerfDailyTable th,.altPerfDailyTable td{padding:9px;border-bottom:1px solid #111d2e;text-align:left;font-size:10px;white-space:nowrap}.altPerfDailyTable th{color:#69768d;text-transform:uppercase;letter-spacing:.07em}.altPerfWin{color:#52e0aa;font-weight:800}.altPerfLoss{color:#ff7188;font-weight:800}.altPerfPush{color:#ffd166;font-weight:800}
