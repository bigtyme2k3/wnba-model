...
window.WNBA_FINAL_ROUTER={version:'2.4',tabs:NAV.map(x=>x[0]),props_api:true,compatibility_helpers:['E','S','q','A','game','score','sortableLabel','sortLabel']};window.render('games')})();</script>'''
