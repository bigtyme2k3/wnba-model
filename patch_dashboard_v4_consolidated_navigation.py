...
const arr=v=>Array.isArray(v)?v:[];const esc=v=>typeof E==='function'?E(v):String(v??'');const val=(v,d='—')=>v===undefined||v===null||v===''?d:v;window.activeGame=window.activeGame||'';
...
window.WNBA_FINAL_ROUTER={version:'2.1',tabs:NAV.map(x=>x[0]),props_api:true};window.render('games')})();</script>'''
...
def main():
 ...
 print('Canonical router and shared Player Props API installed')
