"""WNBA V5 Operations Sprint 3 M06 - evidence-cycle aggregator.

M06 is a terminal consumer of the Sprint 3 evidence modules. Each upstream
module owns its own artifact: M01 freshness, M02 explicit close capture, M11
inference, M03 forward reconciliation, M04 CLV, and M05 promotion evidence.
M06 never reruns or republishes those producers and never writes the canonical
M12 forward ledger.
"""
...
def main():
    ...
    cycle={
        ...
        'stage':'EVIDENCE_CYCLE_AGGREGATOR','generated_at_utc':now,
        'status':'READY' if modules_ready else 'WAITING_FOR_REQUIRED_MODULE_OUTPUTS',
        'consumer_only':True,
        'canonical_forward_ledger_owner':'V5-M12',
        ...
        'api_policy':{
            ...
            'reason':'M06 is an aggregator only and never invokes source or evidence producers.'
        },
        'safety':{
            ...
            'upstream_artifacts_republished':False,
        },
        ...
        'policy':'M06 summarizes independently-owned evidence modules; it does not execute or publish their canonical artifacts.'
    }
    sprint_status={
